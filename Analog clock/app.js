...
function getCurentTime(){
    ...
    // 12 hours = 360deg so 1h = 360 / 12 = 30deg  
    // 1 hour = 30deg that means 60 min = 30deg so 1 min = 30 / 60 = 0.5 or 1/2deg
    // so formula for hours is (hour * 30 + minutes / 2)
...
setInterval(getCurentTime, 1000) //1000ms = 1s